...
namespace beam
{
    ...
    pair<po::options_description, po::options_description> createOptionsDescription(int flags)
    {
        ...
        wallet_options.add_options()
            ...
            (cli::AMOUNT_FULL, po::value<double>(), "amount to send (in Cash, 1 Cash = 100,000,000 csats)")
            (cli::FEE_FULL, po::value<Amount>()->default_value(0), "fee (in Csats, 100,000,000 csats = 1 Cash)")
