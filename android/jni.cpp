...
#define LITECASH_JAVA_PACKAGE(sep)                     com ## sep ## mw ## sep ## beam ## sep ## LitecashWallet ## sep ## core
#define LITECASH_JAVA_PREFIX                         LITECASH_JAVA_PACKAGE(_)
#define LITECASH_JAVA_PATH                             "com/mw/beam/LitecashWallet/core" // doesn't work on clang DEF2STR(LITECASH_JAVA_PACKAGE(/))
#define LITECASH_JAVA_API_INTERFACE(function)         CONCAT1(LITECASH_JAVA_PREFIX, Api, function)
#define LITECASH_JAVA_WALLET_INTERFACE(function)     CONCAT1(LITECASH_JAVA_PREFIX, entities_Wallet, function)
...
namespace
{
    ...
    struct WalletModel : IWalletModelAsync, IWalletObserver
    {
        ...
        void onGeneratedNewAddress(const WalletAddress& address)
        {
            ...
            jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onGeneratedNewAddress", "(L" LITECASH_JAVA_PATH "/entities/dto/WalletAddressDTO;)V");
        ...
        void onStatus(const WalletStatus& status)
        {
...

            {
                ...
                jfieldID systemStateID = env->GetFieldID(WalletStatusClass, "system", "L" LITECASH_JAVA_PATH "/entities/dto/SystemStateDTO;");
                env->SetObjectField(walletStatus, systemStateID, systemState);
            }

            ////////////////

            jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onStatus", "(L" LITECASH_JAVA_PATH "/entities/dto/WalletStatusDTO;)V");
        ...
        void onTxStatus(beam::ChangeAction action, const std::vector<beam::TxDescription>& items) 
        {
            ...
            jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onTxStatus", "(I[L" LITECASH_JAVA_PATH "/entities/dto/TxDescriptionDTO;)V");
        ...
        void onAllUtxoChanged(const std::vector<beam::Coin>& utxosVec) 
        {
            ...
            jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onAllUtxoChanged", "([L" LITECASH_JAVA_PATH "/entities/dto/UtxoDTO;)V");
        ...
        void onAdrresses(bool own, const std::vector<beam::WalletAddress>& addresses) 
        {
            ...
            jmethodID callback = env->GetStaticMethodID(WalletListenerClass, "onAdrresses", "(Z[L" LITECASH_JAVA_PATH "/entities/dto/WalletAddressDTO;)V");
...
JNIEXPORT jobject JNICALL LITECASH_JAVA_API_INTERFACE(createWallet)(JNIEnv *env, jobject thiz,
...
JNIEXPORT jboolean JNICALL LITECASH_JAVA_API_INTERFACE(isWalletInitialized)(JNIEnv *env, jobject thiz,
    jstring appData)
{
...
JNIEXPORT jobject JNICALL LITECASH_JAVA_API_INTERFACE(openWallet)(JNIEnv *env, jobject thiz,
...
JNIEXPORT jobject JNICALL LITECASH_JAVA_API_INTERFACE(createMnemonic)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(getWalletStatus)(JNIEnv *env, jobject thiz)
{
    LOG_DEBUG() << "getWalletStatus()";
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(getUtxosStatus)(JNIEnv *env, jobject thiz)
{
    LOG_DEBUG() << "getUtxosStatus()";
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(syncWithNode)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(sendMoney)(JNIEnv *env, jobject thiz,
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(calcChange)(JNIEnv *env, jobject thiz,
    jlong amount)
{
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(getAddresses)(JNIEnv *env, jobject thiz,
    jboolean own)
{
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(generateNewAddress)(JNIEnv *env, jobject thiz)
{
...
JNIEXPORT void JNICALL LITECASH_JAVA_WALLET_INTERFACE(saveAddress)(JNIEnv *env, jobject thiz,
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/listeners/WalletListener");
        WalletListenerClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/Wallet");
        WalletClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/dto/WalletStatusDTO");
        WalletStatusClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/dto/SystemStateDTO");
        SystemStateClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/dto/TxDescriptionDTO");
        TxDescriptionClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/dto/UtxoDTO");
        UtxoClass = reinterpret_cast<jclass>(env->NewGlobalRef(cls));
    }

    {
        jclass cls = env->FindClass(LITECASH_JAVA_PATH "/entities/dto/WalletAddressDTO");
